...
### Вопрос: Какие версии приставок существуют? В чем разница между NEXT Air и NEXT Pro?

Мы предлагаем две основные линейки смарт-приставок:

1.  **NEXT Pro (2/16 ГБ)** — Флагманская модель для максимального комфорта и игр.
    -   **Процессор:** Мощный Allwinner H618 (64-bit).
    -   **Память:** 2 ГБ ОЗУ / 16 ГБ встроенной.
    -   **ОС:** Новейшая **NEXT OS Chara**.
    -   **Фишки:** Собственный магазин приложений, динамические "живые" обои, умные рекомендации, современный дизайн.
    -   **Гейминг:** Поддерживает облачный гейминг (VK Play, MTS Fog Play).

2.  **NEXT Air** — Новая улучшенная модель 2026 года. Компактнее и легче NEXT Pro, при этом не уступает ему в мощности.
    -   **Память:** 2 ГБ ОЗУ / 32 ГБ встроенной.
    -   **Процессор:** RK3518 (Quad-Core Cortex-A53).
    -   **Wi-Fi 6:** Dual Band 2.4 + 5 GHz (802.11 b/g/n/ac/ax).
    -   **Видео:** 4K UHD @ 60fps, H.264/H.265.
    -   **Размер:** 82×82×17 мм — компактный и лёгкий корпус.

### Вопрос: Можно ли играть в игры на приставке?
Ответ: Да! На модели **NEXT Pro** вы можете играть даже в современные компьютерные игры (Cyberpunk 2077, GTA V, Atomic Heart) благодаря поддержке **облачного гейминга**. Просто установите приложения сервисов **VK Play** или **MTS Fog Play**, подключите геймпад и играйте с высоким качеством графики. **NEXT Air** — мощная компактная модель 2026 года, не уступает Pro по производительности и отлично справляется с приложениями и контентом.

### Вопрос: Чем NEXT Air отличается от NEXT Pro? Какую модель выбрать?
Ответ: **NEXT Air** — новая улучшенная модель 2026 года. Она компактнее и легче NEXT Pro, при этом не уступает ему в мощности. Идеальна для тех, кто ценит малый размер и удобство. **NEXT Pro** — флагман с облачным геймингом и магазином приложений. Выбирайте Pro, если нужны игры; Air — если приоритет компактность и производительность в одном корпусе.

### Вопрос: Какие технические характеристики у приставки?

| Компонент | NEXT Pro (Флагман) | NEXT Air (модель 2026) |
| :--- | :--- | :--- |
| **Процессор** | **Allwinner H618** (64-bit) | RK3518 (Quad-Core Cortex-A53) |
| **ОС** | **NEXT OS Chara** | Android 14 + NEXT OS |
| **Память** | 2/16 ГБ | 2/32 ГБ |
| **Видео** | 4K, HDR10+, 6K@30fps | 4K UHD @ 60fps, H.264/H.265 |
| **Wi-Fi** | Dual Band (2.4 + 5 GHz) | Wi-Fi 6 Dual Band (2.4 + 5 GHz) |
| **Особенности** | Облачный гейминг, свой магазин | Компактнее и легче Pro, не уступает в мощности |

### Вопрос: Есть ли в пульте голосовое управление или Bluetooth?

Ответ: Нет, в стандартном пульте **отсутствуют встроенный Bluetooth и микрофон**. Управление осуществляется через ИК-порт.

Однако вы можете расширить функционал, используя USB-порты приставки:

- **Для голосового управления:** Можно подключить внешний пульт (Air Mouse) с микрофоном (через USB-приемник).
- **Для Bluetooth-устройств:** Можно подключить внешний USB-Bluetooth адаптер (приобретается отдельно).
...
### Вопрос: Не появляется клавиатура при вводе пароля от Wi-Fi при первом включении. Что делать?

Ответ: Если во время первоначальной настройки и попытки подключения к Wi-Fi на экране не появляется виртуальная клавиатура:
1. Пропустите этот шаг настройки (нажмите "Пропустить" или просто перейдите далее), чтобы попасть в главное меню приставки.
2. Из главного меню зайдите в **Настройки** (иконка шестеренки).
3. Найдите раздел настроек клавиатуры (обычно находится в "Настройки устройства" -> "Клавиатура") и включите виртуальную клавиатуру.
4. После этого зайдите в настройки сети (Wi-Fi), выберите вашу сеть и введите пароль — клавиатура должна появиться.

### Вопрос: Как впервые подключить приставку к телевизору?

Здравствуйте!
Чтобы впервые подключить приставку к телевизору:
1. Подключите приставку к ТВ через HDMI-кабель (или через AV, если телевизор старой модели).
2. Подключите блок питания к розетке.
3. Включите телевизор и выберите нужный источник сигнала (HDMI 1/2/3 или AV).
4. Подключите приставку к Wi-Fi или интернету по кабелю.
После этого можно пользоваться приставкой 👍
...
### Вопрос: Что делать, если предложенные советы не помогли? / Приставка не работает / Ничего не помогает / Брак

Ответ: Приносим извинения за доставленные неудобства. Если базовые советы (перезагрузка, проверка кабелей) и сброс настроек не помогли, скорее всего, вы столкнулись с технической неисправностью (браком).
В этом случае:
1. Вы имеете полное право оформить возврат товара. Пожалуйста, перейдите в личный кабинет на маркетплейсе (Wildberries или Ozon), найдите этот заказ и оформите заявку на возврат по причине "Брак".
2. Обязательно приложите видео, на котором видна неисправность — мы оперативно одобрим вашу заявку, и вы сможете вернуть деньги.
3. Если у вас остались вопросы, вы всегда можете написать нам в WhatsApp техподдержки по номеру +7(996)979-54-88 для получения помощи.
...
Ответ: Нет, это не является неисправностью приставки. Наша приставка предоставляет аппаратную платформу и операционную систему Android, но мы не можем гарантировать стабильную работу всех сторонних и даже некоторых предустановленных приложений (кроме NEXT TV). Разработчики приложений часто выпускают обновления, которые могут вызовывать сбои. 

Если у вас не работает конкретное приложение:
1. Попробуйте его обновить или переустановить.
2. Обратитесь в техническую поддержку именно этого приложения, так как мы не контролируем их серверы и обновления.
...
# Архив: Снятие с производства

## NEXT One (архив)

Модель снята с производства. Вместо неё предлагаем **NEXT Air** — новую линейку с улучшенными характеристиками.

### Характеристики NEXT One (для справки)

- **Классическая линейка** для просмотра контента. Доступна в двух версиях:
  - **Версия 2/16 ГБ:** Оптимальный выбор для плавной работы приложений.
  - **Версия 1/8 ГБ:** Базовая версия для ТВ и YouTube.
- **Процессор:** Allwinner H313.
- **ОС:** Android 10 + NEXT OS.
- **Wi-Fi:** 2.4 GHz.
